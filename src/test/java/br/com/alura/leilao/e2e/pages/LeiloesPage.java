...
public class LeiloesPage {
    ...
    public DetalhesDoLeilaoPage visitaPaginaDoLeilaoDo(String donoDoLeilao) throws Exception {
        ...
        String xpath = "//table[@class='table table-hover']/tbody/tr/td[contains(text(),'" + donoDoLeilao + "')]/following-sibling::td/a";
    ...
    public boolean naoPodeDarLanceNoLeilaoCriado(String donoDoLeilao) {
        WebElement href = driver.findElement(By
                .xpath("//table[@class='table table-hover']/tbody/tr/td[contains(text(),'" + donoDoLeilao + "')]/following-sibling::td/a"));
